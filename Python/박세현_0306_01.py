...
from 박세현_0306_02 import Sungjuk
...
def input_sungjuk():
  print()
  obj = Sungjuk()
  obj.input_student_info(lst)
  obj.process_student_sungjuk()
  lst.append(obj)
  print("\n성적 입력 성공!!!\n")
  ...
  while True:
    ...
    try:
        ...
        if 0 < menu <= 6:
          ...
          raise Exception("1 ~ 6 사이의 숫자만 입력가능합니다.")
